...
const MotionButton = motion(Button); // Buat komponen MotionButton dari Shadcn/ui
...
const Login = () => {
  ...
  useEffect(() => {
    // Mengatur warna latar belakang body agar tidak ada kilatan putih
    document.body.style.backgroundColor = '#171717'; // Warna gelap, sesuai dengan background Anda
    return () => {
      document.body.style.backgroundColor = ''; // Mengembalikan ke default saat komponen di-unmount
    };
  }, []);
              ...
              <Card className="border-0 bg-transparent shadow-none">
                ...
                <CardFooter className="flex justify-center">
                  <motion.p
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.5, delay: 1.3 }} // Delay berurutan
                  >
                    Belum punya akun?{' '}
                    <Link href="/register" className="text-yellow-500 hover:text-yellow-400 underline-offset-4 hover:underline">
                      Daftar di sini
                    </Link>
                  </motion.p>
                </CardFooter>
