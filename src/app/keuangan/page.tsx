          ...
          <div className="p-8">
            ...
            >
              ...
              <motion.p
                ...
                key={totalSaldo} // Key helps trigger animation on saldo change
                ...
                >
                  <table className="min-w-full divide-y divide-gray-700">
                    ...
                    <tbody className="bg-black divide-y divide-gray-800">
                      <AnimatePresence mode="wait"> {/* Animate items as they enter/exit the view */}
                        {currentItems.map((item) => (
                          <motion.tr
                            ...
                            animate="visible"
                            exit="hidden"
                            layout // Ensures smooth layout transitions when items are added/removed/filtered
                          >
